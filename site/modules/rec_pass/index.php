...
if (isset($_POST['go'])) {
    ...
    if ($errors === true) {
        ...
        $message = "Для смены пароля пройдите по ссылке:$href. <br> 
            Если вы не собирались менять пароль - просто проигнорируйте это сообщение или обратитесь к администрации сайта!";


        global $_OPTIONS;

        HolyMailSMTP(Array($_OPTIONS['back_email'],
            "Робот-хранитель паролей"
                )
                , $_POST['email'], "Восстановление пароля", $message, "utf-8");
    } else {
